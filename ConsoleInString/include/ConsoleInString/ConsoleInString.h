 ...
 * アクティブ状態ではコンソールからの入力待ちをしているので、非アク
 * ティブ化する場合は非アクティブ化の指示をした後、コンソールから何
 * か文字列を入力する必要がある。
 *
 * OutPort
 * ポート名/型/説明
  ...
  : public RTC::DataFlowComponentBase
{
 public:
   ...
   */
  ConsoleInString(RTC::Manager* manager);
...
extern "C"
{
  DLL_EXPORT void ConsoleInStringInit(RTC::Manager* manager);
};

#endif // CONSOLEINSTRING_H
