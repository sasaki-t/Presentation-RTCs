...
/*!
 * @file  PresentationLPInterfaceTest.h
...
#ifndef PRESENTATIONLPINTERFACE_TEST__H
#define PRESENTATIONLPINTERFACE_TEST_H
...
/*!
 * @class PresentationLPInterfaceTest
  ...
  : public RTC::DataFlowComponentBase
{
 public:
   ...
   */
  PresentationLPInterfaceTest(RTC::Manager* manager);

  /*!
   * @brief destructor
   */
  ~PresentationLPInterfaceTest() override;
 ...
 protected:
   ...
   * - Number: 1
   */
  RTC::OutPort<Img::TimedCameraImage> m_ImageOut;
   ...
   * - Number: 1
   */
  RTC::OutPort<RTC::TimedShort> m_BgUpdateTriggerOut;
...
extern "C"
{
  DLL_EXPORT void PresentationLPInterfaceTestInit(RTC::Manager* manager);
};

#endif // PRESENTATIONLPINTERFACE_TEST_H
